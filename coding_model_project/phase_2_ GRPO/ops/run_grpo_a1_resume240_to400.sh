...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"grpo_a1_formal_observe_lb24_multi2_resume240_to400_seed${SEED}"}
...
resolve_resume_from_path() {
    ...
    local candidate
    local -a candidates=(
        "/workspace/verl/checkpoints/rlvr_coding_model/grpo_a1_formal_observe_lb24_multi2_resume200_to260_seed0/global_step_240"
        "${PHASE2_DIR%/coding_model_project/phase_2_ GRPO}/checkpoints/rlvr_coding_model/grpo_a1_formal_observe_lb24_multi2_resume200_to260_seed0/global_step_240"
    )
    ...
    echo "ERROR: Could not resolve a valid step240 checkpoint. Set RESUME_FROM_PATH explicitly." >&2
    exit 1
}

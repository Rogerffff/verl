...
export LIMITER_BUDGET=${LIMITER_BUDGET:-64}
...
TOTAL_TRAINING_STEPS=${TOTAL_TRAINING_STEPS:-460}
TEST_FREQ=${TEST_FREQ:-20}
SAVE_FREQ=${SAVE_FREQ:-430}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"grpo_a1_formal_observe_lb64_multi4_resume400_to460_seed${SEED}"}
...
resolve_resume_from_path() {
    ...
    local -a candidates=(
        ...
        "${PHASE2_DIR%/coding_model_project/phase_2_ GRPO}/checkpoints/rlvr_coding_model/grpo_a1_formal_observe_lb24_multi2_resume240_to400_seed0/global_step_400"
    )
    ...
    echo "ERROR: Could not resolve a valid step400 checkpoint. Set RESUME_FROM_PATH explicitly." >&2
    exit 1
}

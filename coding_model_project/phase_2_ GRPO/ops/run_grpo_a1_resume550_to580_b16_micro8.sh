...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"grpo_a1_formal_observe_lb128_multi8_b16_micro8_resume550_to580_seed${SEED}"}
...
resolve_resume_from_path() {
    ...
    local candidate
    local -a candidates=(
        "/workspace/verl/checkpoints/rlvr_coding_model/grpo_a1_formal_observe_lb96_multi6_b16_onpolicy_resume520_to580_seed0/global_step_550"
        "${PHASE2_DIR%/coding_model_project/phase_2_ GRPO}/checkpoints/rlvr_coding_model/grpo_a1_formal_observe_lb96_multi6_b16_onpolicy_resume520_to580_seed0/global_step_550"
    )
    ...
    echo "ERROR: Could not resolve a valid step550 checkpoint. Set RESUME_FROM_PATH explicitly." >&2
    exit 1
}

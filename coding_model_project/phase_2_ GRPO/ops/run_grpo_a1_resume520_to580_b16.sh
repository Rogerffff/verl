...
export LIMITER_BUDGET=${LIMITER_BUDGET:-96}
...
TOTAL_TRAINING_STEPS=${TOTAL_TRAINING_STEPS:-580}
TEST_FREQ=${TEST_FREQ:-20}
SAVE_FREQ=${SAVE_FREQ:-550}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"grpo_a1_formal_observe_lb96_multi6_b16_onpolicy_resume520_to580_seed${SEED}"}
...
resolve_resume_from_path() {
    ...
    local candidate
    local -a candidates=(
        "/workspace/verl/checkpoints/rlvr_coding_model/grpo_a1_formal_observe_lb96_multi6_resume460_to520_seed0/global_step_520"
        "${PHASE2_DIR%/coding_model_project/phase_2_ GRPO}/checkpoints/rlvr_coding_model/grpo_a1_formal_observe_lb96_multi6_resume460_to520_seed0/global_step_520"
    )
    ...
    echo "ERROR: Could not resolve a valid step520 checkpoint. Set RESUME_FROM_PATH explicitly." >&2
    exit 1
}
